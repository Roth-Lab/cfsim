...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--hapclone-data-file", type=str, required=True)

    parser.add_argument("-r", "--hapclone-results-file", type=str, required=True)
    
    parser.add_argument("-s", "--snp-file", type=str, required=True)

    parser.add_argument("-o", "--out-file", type=str, required=True)

    parser.add_argument("-c", "--coverage", type=float, required=True)

    parser.add_argument("-p", "--clone-prevalence-prior", type=float, required=True)

    parser.add_argument("-t", "--tumour-content", type=float, required=True)

    parser.add_argument("--clone-prevalence-file", type=str, required=True)
